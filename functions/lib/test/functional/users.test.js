...
describe("Testes funcionais do Users", () => {
    describe.skip("Quando criar um novo usuario", () => {
        it("deve criar um novo usuario com sucesso com senha criptografada", async () => {
            ...
            await user_1.User.findOneAndDelete({ email: newUser.email });
    ...
    describe("quando autenticar o usuario", () => {
        it.skip("deve gerar o token para o usuario valido", async () => {
            const newUser = {
                name: "John doe",
                email: "testeTESTE@testeTESTE.com",
                password: "1234",
